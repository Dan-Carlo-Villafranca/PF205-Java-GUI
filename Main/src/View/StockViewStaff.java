...
import Staff.addStockStaff;
import javax.swing.table.TableModel;



public class StockViewStaff extends javax.swing.JFrame {

    public StockViewStaff() {
        initComponents();
    ...
    String sql = "SELECT b_id AS 'ID', blood_type AS 'Type', quantity AS 'Quantity' FROM tbl_blood";
...
//        new Users().setVisible(true);
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        addStockStaff as = new addStockStaff();
        as.action = "Add";
        as.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new StockViewStaff().setVisible(true);
            }
            }
        });
    }
