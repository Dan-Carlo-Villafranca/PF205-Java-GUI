...
void getDonationData() {
    ...
    // 1. Fixed table/column names (tbl_donations, d_id, d_date)
    // 2. Added 'quantity' so Approval logic doesn't crash
    // 3. Added Parentheses and 'Pending' status for safety
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new DonationView().setVisible(true);
            }
            }
        });
    }
