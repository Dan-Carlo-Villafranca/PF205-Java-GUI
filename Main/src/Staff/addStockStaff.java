...
public class addStockStaff extends javax.swing.JFrame {

    public String action =""; 
    public int userID;
    
    public addStockStaff() {
        initComponents();
    }
    ...
    if(bloodtype.isEmpty() || quan.isEmpty() || bloodtype.equals("Blood Type") || quan.equals("Quantity")) {
        ...
        private void closeAndReturn() {
                ...
                this.dispose();
                StockViewStaff sv = new StockViewStaff();
                sv.setVisible(true);
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addStockStaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new addStockStaff().setVisible(true);
            }
            }
        });
    }
